...
STUDENTS = [
    ...
    dict(name="Daniel Lim", uni="Sunway University", major="BSc Computer Science", year=2, cat="Web",
         ...
         rating=4.8, rating_count=17, lo=800, hi=1500, avail="now", langs="EN · BM · 中文", site="https://daniellim.dev",
    ...
    dict(name="Mei Ling Chong", uni="UTAR Sungai Long", major="BSc Software Engineering", year=4, cat="Design",
         ...
         rating=4.9, rating_count=21, lo=500, hi=900, avail="from", avail_from="2026-07-10", langs="EN · 中文 · BM", site="https://meiling.design",
